...
photoscanDir=r"C:\Program Files\Agisoft\PhotoScan Pro"
...
codeDir=r"C:\Users\ivan\Documents\GitHub\PhotoscanPipeline\PhotoscanProcessing_slave.py"
...
image_folder = r"F:\Ivan\ScalePaper_photos\Blade_photos"


# Directory of the created slices
save_folder=r"F:\Ivan\ScalePaper_photos\Blade_photos\slices"

# Name of the coordinate reference file, IF THERE IS NO REFERENCE FILE WRITE - "noRef" instead
coordReference = "geotagging.txt"
outputPointCloud = "outputCloud_20_12_18"
...
slicer_v1(pointCloud_verts,save_folder)   
