...
#    folder = r"F:\Ivan\ScalePaper_photos\Blade_photos"
#    coordReference = 'geotagging.txt'
#    outputPointCloud = 'outputCloud_20_12_18'
#    keypointLimit = int(float('80000'))
#    tiepointLimit = int(float('80000'))
#    filterReprojectionError_thresh = float('0') #0.3
#    filterImageCount_thresh = int(float('0')) #2
#    filterReconstructionUncertainty_thresh = int(float('0')) #15
#    decimateMesh_size = int(float('1000000'))
#    
#    alignAccuracy = alignSwitcher('A_high')
#    
#    denseCloudQuality = densePCSwitcher('PC_medium')
